...
smjq(document).ready(function(){
		...
		smjq("body").append('<div id="smchuncai" onfocus="this.blur();" style="color:#626262;z-index:999;"><div id="chuncaiface"></div><div id="dialog_chat"><div id="chat_top"></div><div id="dialog_chat_contents"><div id="dialog_chat_loading"></div><div id="tempsaying"></div><div id="showchuncaimenu"><ul class="wcc_mlist" id="chatTochuncai">聊&nbsp;&nbsp;&nbsp;&nbsp;天</ul><ul class="wcc_mlist" id="foods">吃 零 食</ul><ul class="wcc_mlist" id="blogmanage">神秘博客</ul><ul class="wcc_mlist" id="closechuncai">关闭春菜</ul></div><div><ul id="chuncaisaying"></ul></div><div id="getmenu"> </div></div><div id="chat_bottom"></div></div></div>');
		...
		smjq("#blogmanage").click(function(){
				...
				setFace(2);
				setTimeout(function(){
					window.location.href = path+'wordpress/';
					}, 2000);
				});
...
function getdata(el, id){
	smjq.ajax({
		type:	'GET',
		url:	path+'/content/plugins/weichuncai/ajax_json.php',
		cache:	'false',
		dataType: 'html',
		...
		error: function(){
			chuncaiSay('好像出错了，是什么错误呢...请联系那个不管我的鹳狸猿哦～');
		}
		});
}
...
function setTime(){
	...
	if(parseInt(tol) == parseInt(goal)){
		...
		closeNotice();
		closeInput();
		chuncaiSay("主人跑到哪里去了呢，才不要没有主人的感觉>_<!!....");
		setFace(3);
		stoptime();
	}
}
...
var talkself_arr = [
	...
	["某America的某Microsoft公司好差劲的说，还是FC-System给力～","3"],
	["主人来...来嘛～乃说吾喵可耐还素蓝泽光可耐捏？","3"],
	["喵喵喵～～～","2"],
	["啊哈，又出现什么新的韧体了木有呢？？","1"],
	["网站是山寨的说，乃们知道么？","1"]
];
